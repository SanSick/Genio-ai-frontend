          ...
          <div className="mb-6 bg-white p-4 shadow rounded-lg">
            ...
            <div>
              ...
              {data?.user?.subscriptionPlan === "Trial" && (
                <p className="border rounded mb-4 w-full py-2 px-3 text-gray-700 leading-tight">
                  Trail: 100 monthly request
                </p>
              )}
              {data?.user?.subscriptionPlan === "Free" && (
                <p className="border rounded mb-4 w-full py-2 px-3 text-gray-700 leading-tight">
                  Free: 200 monthly request
                </p>
              )}
              {data?.user?.subscriptionPlan === "Basic" && (
                <p className="border rounded mb-4 w-full py-2 px-3 text-gray-700 leading-tight">
                  Basic: 500 monthly request
                </p>
              )}
              {data?.user?.subscriptionPlan === "Premium" && (
                <p className="border rounded mb-4 w-full py-2 px-3 text-gray-700 leading-tight">
                  Premium: 1000 monthly request
                </p>
              )}
              <Link
                to="/plans"
